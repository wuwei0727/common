...
@Component
@Slf4j
public class PromoterQrCodeUtil {
    /**
     *上传真实地址
     */
     ...
     *
     */
    public static String getPromoterQrCode(Integer id,String mapId) {
        //文件生成时间时间
        ...
        try {
            ...
            // 携带参数
            paramJson.put("scene", String.join("","id=" + id, "&mapId=" + mapId));
    ...
    public static void main(String[] args){
        ...
        // int destId = 493;
        // String mapId = "75";
        // String shangjiaName = "臻赞汽车精护中心";
        // String floor = "1";
        // String x = "2653507.2463";
        // String y = "12634587.167885464";
        // String fid = "6874884973103550464L";
        //
        // String queryString = generateQueryString(promoterId, destId, mapId, shangjiaName, floor, x, y, fid);
        // System.out.println(queryString);

        // PromoterQrCode code = new PromoterQrCode();
        // code.setProInfoId(1);
        // code.setDestId(493);
        // code.setMapId("75");
        // code.setMapName("香雪国际公寓");
        // code.setDestId(493);
        // code.setFloor("2");
        // code.setX("2653507.2463");
        // code.setY("12634587.167885464");
        // code.setFid("6874884973103550464L");
        // getPromoterQrCode(code);

        String promoterQrCodeId = "1";
        String mapId ="1";
        String.join("promoterQrCodeId=" + promoterQrCodeId, "mapId=" + mapId);
    }
