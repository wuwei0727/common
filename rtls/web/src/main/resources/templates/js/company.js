...
function loadSeleData() {
    ...
    loadFun('park/getCompany', {pageSize: -1}, '#comSelect');
    loadFun('park/getShangjiaType', {pageSize: -1}, '#typeid');
}
...
function detail(id) {
    ...
    $('#editFrame').attr('src', './companyDetails.html?id=' + id) 
    $('#editFrame').show()
}

function addCompany() {
    $('#addFrame').attr('style', 'z-index: 99') 
    $('#addFrame').attr('src', './companyDetails.html') 
    $('#addFrame').show()
}
