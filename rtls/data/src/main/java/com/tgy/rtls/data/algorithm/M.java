...
public static String data="";
    ...
    public static void main(String[] args) {
       System.out.println("开始：");
          double[][] bspos= {{0f,0f,2},{10.1f,0f,2},{10.01f,10f,2},{0.01f,10f,2},};
        double[] dis= {7,7,15.8,15.8};
        sameLine(bspos);
        double[] dos={0,0,0,0};
...
*/
    private static boolean sameLine(double[][] bspos) {
    ...
    public static double[] location_Minum( double[][] bspos,double[] dis) {
      ...
      /*  double personheight=2;
        ...
        if(zhi==2&&res!=null) {
            double[] finalres= {res[0][0],res[1][0]};
            return finalres;
